...
import type { BanduraSourceId, BanduraEntry, BanduraStats, BanduraChallengeProps } from '@/types/banduraTypes';
...
// ============================================
const BANDURA_IMAGES: Record<BanduraSourceId, { url: string; label: string }[]> = {
  mastery: [
            ...
            <AnimatePresence>
              {selectedSource && (
                ...
                >
                  ...
                  >
                    {BANDURA_IMAGES[selectedSource].map((img, idx) => (
                      <motion.div
                        key={idx}
