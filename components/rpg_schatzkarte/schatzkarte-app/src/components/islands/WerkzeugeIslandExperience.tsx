...
import { PowertechnikenChallenge } from '@/components/PowertechnikenChallenge';
import { PowerTechnikenLernpfad } from '@/components/PowerTechnikenLernpfad';
import { WerkzeugeIcon } from '@/components/icons';
...
export function WerkzeugeIslandExperience() {
  ...
  const onOpenLernkarten: (() => void) | undefined = undefined;
  const onOpenSchatzkammer: (() => void) | undefined = () => navigate('/karte/schatzkammer');
