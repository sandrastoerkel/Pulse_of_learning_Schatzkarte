...
import { MeisterBergIcon } from '@/components/icons';
...
export function MeisterBergIslandExperience() {
    ...
    <div className="meister-berg-island">
      <div className="island-header">
        ...
        <h1 className="island-title">
          <motion.div className="title-icon" animate={{ scale: [1, 1.1, 1] }} transition={{ repeat: Infinity, duration: 3 }}><MeisterBergIcon size={40} animated /></motion.div>
      ...
      <motion.div className="island-subtitle-bar" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <motion.span className="finale-badge" animate={{ scale: [1, 1.1, 1], rotate: [0, 3, -3, 0] }} transition={{ repeat: Infinity, duration: 2 }}>🏆 FINALE</motion.span>
      </motion.div>
