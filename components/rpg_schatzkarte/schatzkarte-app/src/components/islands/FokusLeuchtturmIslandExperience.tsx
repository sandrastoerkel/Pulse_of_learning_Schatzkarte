...
import { FokusLeuchtturmIcon } from '@/components/icons';
...
const ISLAND_ID = 'fokus_leuchtturm';
...
const QUEST_INFO: Record<QuestKey, { name: string; icon: string; color: string; description: string; xp: number }> = {
  ...
  scroll: { name: 'Schriftrolle studieren', icon: '📖', color: '#ff8a65', description: 'Lerne über Konzentration!', xp: 20 },
  quiz: { name: 'Wissen testen', icon: '⚔️', color: '#ff7043', description: 'Teste dein Wissen!', xp: 50 },
  challenge: { name: 'Fokus-Übung', icon: '🎯', color: '#f4511e', description: 'Schärfe deinen Fokus!', xp: 40 },
};

export function FokusLeuchtturmIslandExperience() {
    ...
    <div className="fokus-leuchtturm-island">
      <div className="island-header">
        ...
        <h1 className="island-title">
          <motion.div className="title-icon" animate={{ scale: [1, 1.1, 1] }} transition={{ repeat: Infinity, duration: 3 }}><FokusLeuchtturmIcon size={40} animated /></motion.div>
          Fokus halten
        </h1>
