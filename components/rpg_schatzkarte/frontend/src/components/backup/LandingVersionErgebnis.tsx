...
interface LandingVersionErgebnisProps {
  onClose?: () => void;
  onGuestMode?: () => void;
}

export default function LandingVersionErgebnis({ onClose, onGuestMode }: LandingVersionErgebnisProps) {
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', alignItems: 'center' }}>
            ...
            <div style={{ flex: '1 1 450px' }}>
              ...
              <h1 style={{
                ...
                wenn es weiß, <span style={{ color: '#16a34a' }}>wie man lernt</span>
              </h1>
              <p style={{ fontSize: '20px', color: '#4b5563', marginBottom: '32px', lineHeight: 1.6 }}>
                In 12 Wochen entwickelt dein Kind die Lernstrategien der Überflieger – basierend auf der Forschung von John Hattie & Albert Bandura.
              </p>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '24px', marginTop: '40px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <LehrerinIcon size={48} />
                  <div>
                    <div style={{ fontSize: '18px', fontWeight: 700, color: '#111827' }}>20+ Jahre</div>
                    <div style={{ fontSize: '14px', color: '#6b7280' }}>Lehrerin</div>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <DataScienceIcon size={48} />
                  <div>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
            {[
              ...
              { text: '"Mein Sohn hat zum ersten Mal Spaß am Lernen. Die Schatzkarte ist genial!"', author: 'Vater von Max, 10 Jahre' }
            ].map((t, i) => (
              <div key={i} style={{
                background: '#f9fafb',
                borderRadius: '20px',
