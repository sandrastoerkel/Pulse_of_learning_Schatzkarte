...
// XP Badge Component
const XPBadge = ({ value }: { value: string | number }) => (
  <div style={{
...
// Achievement Card
const AchievementCard = ({ emoji, title, unlocked }: { emoji: string; title: string; unlocked: boolean }) => (
  <div style={{
...
export default function VersionCPlayfulEdtech({ onClose }: { onClose?: () => void }) {
