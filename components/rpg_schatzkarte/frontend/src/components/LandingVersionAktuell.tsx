...
import { LehrerinIcon } from './LehrerinIcon';
import { DataScienceIcon } from './DataScienceIcon';
import { FamilieIcon } from './FamilieIcon';
import { SchulranzenIcon } from './SchulranzenIcon';
import { BuecherIcon } from './BuecherIcon';
...
// LANDING PAGE PROPS
// =============================================
interface LandingVersionAktuellProps {
  onClose?: () => void;
}
...
// LANDING PAGE
// =============================================
export function LandingVersionAktuell({ onClose }: LandingVersionAktuellProps) {
  ...
  return (
    <div className="landing-page-v5" style={{ background: 'white', fontFamily: "'Inter', system-ui, -apple-system, sans-serif", color: '#111827', fontSize: '16px', lineHeight: 1.5, overflow: 'visible' }}>
      ...
      <section style={{
        ...
        {/* Decorative elements */}
        <div style={{ position: 'absolute', top: '100px', right: '10%', width: '300px', height: '300px', background: 'radial-gradient(circle, #bbf7d0 0%, transparent 70%)', opacity: 0.5, pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', top: '200px', left: '5%', width: '400px', height: '400px', background: 'radial-gradient(circle, #fef3c7 0%, transparent 70%)', opacity: 0.4, pointerEvents: 'none' }} />
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '900px', margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Die Herausforderung ist <em style={{ fontStyle: 'italic', color: '#374151' }}>gehirngerecht</em> zu lernen – das Geheimnis der Überflieger!
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <LehrerinIcon size={32} animated={true} glowing={true} />
                <div style={{ textAlign: 'left' }}>
                  <div style={{ fontSize: '14px', fontWeight: 700, color: '#111827', lineHeight: 1.2 }}>20+ Jahre</div>
                  <div style={{ fontSize: '11px', color: '#6b7280' }}>Lehrerin</div>
                </div>
              </div>
              <div style={{ width: '1px', background: '#e5e7eb' }} />
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <DataScienceIcon size={32} animated={true} glowing={true} />
                <div style={{ textAlign: 'left' }}>
                  <div style={{ fontSize: '14px', fontWeight: 700, color: '#111827', lineHeight: 1.2 }}>Data Science</div>
                  <div style={{ fontSize: '11px', color: '#6b7280' }}>zertifiziert</div>
                </div>
              </div>
              <div style={{ width: '1px', background: '#e5e7eb' }} />
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <FamilieIcon size={32} animated={true} glowing={true} />
                <div style={{ textAlign: 'left' }}>
                  <div style={{ fontSize: '14px', fontWeight: 700, color: '#111827', lineHeight: 1.2 }}>2 Kinder</div>
                  <div style={{ fontSize: '11px', color: '#6b7280' }}>im Schulsystem</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section style={{ padding: '60px 24px', background: '#f9fafb', borderTop: '1px solid #e5e7eb', borderBottom: '1px solid #e5e7eb' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <p style={{ textAlign: 'center', color: '#4b5563', marginBottom: '30px', fontSize: '16px', maxWidth: '800px', margin: '0 auto 30px auto', lineHeight: 1.6 }}>
            Als Data Scientist habe ich PISA- und TIMSS-Daten analysiert – und entdeckt: <strong style={{ color: '#15803d' }}>Selbstwirksamkeit ist der stärkste Faktor für Schülerleistung</strong>. Begeistert stellte ich fest, dass führende Lernforscher genau das bestätigen. Ihre Erkenntnisse übersetze ich in den Schulalltag:
          </p>
      ...
      <section style={{ padding: '80px 24px', background: 'white' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          {/* Klingt ganz nach dir? + Stressed Student Image */}
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '50px', alignItems: 'center', marginBottom: '60px' }}>
            ...
            <div style={{ flex: '1 1 300px', maxWidth: '400px' }}>
              <div style={{ borderRadius: '20px', overflow: 'hidden', boxShadow: '0 15px 40px rgba(0,0,0,0.15)' }}>
                <img src="images/stressed-student.jpg" alt="Gestresste Schülerin" style={{ display: 'block', width: '100%', height: 'auto' }} />
              </div>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '24px', justifyContent: 'center' }}>
            ...
            <div style={{ flex: '1 1 300px', maxWidth: '340px', background: 'white', borderRadius: '20px', padding: '30px', boxShadow: '0 8px 30px rgba(0,0,0,0.08)', border: '1px solid #e5e7eb', textAlign: 'center' }}>
              ...
              <span style={{ display: 'inline-block', background: '#f3e8ff', color: '#7c3aed', padding: '6px 14px', borderRadius: '20px', fontSize: '13px', fontWeight: 600 }}>Hattie · Birkenbihl</span>
            </div>
            {/* Karte 3 */}
            <div style={{ flex: '1 1 300px', maxWidth: '340px', background: 'white', borderRadius: '20px', padding: '30px', boxShadow: '0 8px 30px rgba(0,0,0,0.08)', border: '1px solid #e5e7eb', textAlign: 'center' }}>
          ...
          {/* Mein Ansatz */}
          <div style={{ maxWidth: '700px', margin: '70px auto 0 auto' }}>
          ...
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ background: '#f8fafc', borderRadius: '16px', padding: '24px', border: '1px solid #e2e8f0' }}>
              <p style={{ fontSize: '17px', color: '#374151', lineHeight: 1.7, margin: 0 }}>
                <strong style={{ color: '#111827' }}>Mein Ziel:</strong> Dein Kind soll lernen, <strong style={{ color: '#16a34a' }}>wie es selbstständig erfolgreich lernt</strong>.
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '50px', alignItems: 'center' }}>
            ...
            <div style={{ flex: '1 1 350px' }}>
              <div style={{ background: '#f9fafb', borderRadius: '16px', padding: '20px', display: 'flex', alignItems: 'center', gap: '20px', border: '1px solid #e5e7eb', marginBottom: '14px' }}>
                <SchulranzenIcon size={48} animated={true} glowing={true} />
                <div>
                  <div style={{ fontWeight: 700, color: '#111827', fontSize: '17px' }}>Vor dem Übertritt</div>
                  <div style={{ color: '#16a34a', fontWeight: 600, fontSize: '14px' }}>Klasse 3–4</div>
                </div>
              </div>
              <div style={{ background: '#f9fafb', borderRadius: '16px', padding: '20px', display: 'flex', alignItems: 'center', gap: '20px', border: '1px solid #e5e7eb', marginBottom: '14px' }}>
                <BuecherIcon size={48} animated={true} glowing={true} />
                <div>
                  <div style={{ fontWeight: 700, color: '#111827', fontSize: '17px' }}>Unterstufe</div>
                  <div style={{ color: '#16a34a', fontWeight: 600, fontSize: '14px' }}>Klasse 5–7</div>
                </div>
              </div>
              <div style={{ background: '#f9fafb', borderRadius: '16px', padding: '20px', display: 'flex', alignItems: 'center', gap: '20px', border: '1px solid #e5e7eb', marginBottom: '14px' }}>
                <ZielIcon size={48} animated={true} glowing={true} />
                <div>
                  <div style={{ fontWeight: 700, color: '#111827', fontSize: '17px' }}>Mittelstufe</div>
                  <div style={{ color: '#16a34a', fontWeight: 600, fontSize: '14px' }}>Klasse 8–10</div>
                </div>
              </div>
...
export default LandingVersionAktuell;
