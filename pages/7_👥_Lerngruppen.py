...
try:
    ...
    from utils.lerngruppen_db import (
        ...
        create_invitation, get_invitation, get_invitation_url,
        use_invitation, get_group_invitations,
...
# ============================================
# EINLADUNGS-HANDLING (URL Query Parameter)
# ============================================
...
def handle_invitation_from_url():
    ...
    if st.button("Gruppe beitreten", type="primary", use_container_width=True):
        ...
        if result['success']:
            # Willkommens-Email senden wenn Email in der Einladung vorhanden
            _send_welcome_after_join(invitation, user_id)
            # Willkommens-Seite statt sofortigem Redirect
